...
export const LIGHTING = [
    ...
    { id: 'rembrandt', label: 'lighting.rembrandt.label', sub: 'Rembrandt', description: 'lighting.rembrandt.desc', prompt: 'rembrandt lighting, triangle of light on cheek, classical portrait lighting, artistic shadows', icon: '/icons/lighting/rembrant.png' },
