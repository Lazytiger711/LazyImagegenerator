...
export const STYLES = [
    ...
    { id: 'oil_painting', label: 'styles.oil_painting.label', sub: 'Van Gogh', prompt: 'vincent van gogh style, post-impressionist, swirling brushstrokes, impasto texture, vibrant colors, starry night inspired, thick oil paint, emotional expression', neg: '--no photo, digital art, pixel art, smooth', icon: '/icons/styles/oil_painting.png', displayStyle: 'full' },
